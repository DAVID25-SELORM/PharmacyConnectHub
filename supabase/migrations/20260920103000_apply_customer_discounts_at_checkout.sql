-- Apply wholesaler customer discounts inside the existing atomic checkout path.
-- Client-supplied prices are ignored; products.price_ghs remains authoritative.
