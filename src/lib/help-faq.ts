...
export const helpFaqs: HelpFaq[] = [
  ...
  { id: "required-documents", category: "getting-started", roles: ["all"], question: "What documents are required for verification?", answer: "Pharmacies upload a Pharmacy Council License and Business Registration. Wholesalers upload a Wholesale Pharmacy License, FDA Certificate and Business Registration. Upload them from the Verification page after you sign in.", keywords: ["documents", "licence", "license", "upload"] },
  { id: "rejected-verification", category: "getting-started", roles: ["all"], question: "Why was my verification rejected, and how do I replace a document?", answer: "Some information or documents need to be updated before your account can be approved. Sign in, open the Verification page, read the review feedback and use Replace on the affected document. Marketplace features stay locked until your business is approved.", keywords: ["rejected", "replace", "resubmit", "document"] },
  { id: "after-approval", category: "getting-started", roles: ["all"], question: "What happens after my business is approved?", answer: "Your DrugXOne workspace opens the next time you sign in or refresh your verification status. You do not need a new account.", keywords: ["approved", "workspace", "access"] },
